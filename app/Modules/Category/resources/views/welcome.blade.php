...
<div class="card">
  <div class="card-header">
    ...
    <h3 class="card-title"><b>Category</b></h3>
         <a class="btn btn-danger float-right" href="{{ route('category.showtrash') }}" role="button"><i class="fa fa-trash" aria-hidden="true"></i> Trash</a>&nbsp;
        <a class="btn btn-success float-right" href="{{ route('category.add') }}" role="button"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
  </div>
  ...
  <div class="card-body">
    ...
    <tbody>
      ...
      <td>
        <div>
        <a href="{{ route('category.edit',[$col->id]) }}"><i class="fas fa-pencil-alt"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="{{ route('category.index2') }}"class="delete" data-id="{{ $col->id }}"><i class="fas fa-trash-alt"></i></a>
        </div>
      </td>
